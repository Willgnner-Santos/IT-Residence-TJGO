...
> **Print sugerido:** tela do Hue mostrando o script acima e o resultado da consulta.
...
> **Print sugerido:** tela do Mongo Express mostrando a coleção `processos_metricas`.
...
> **Print sugerido:**  
> - dashboard completo do Metabase com os quatro gráficos;  
> - zoom no gráfico de dispersão;  
> - zoom no gráfico de barras por classificação.
